...
type IAdminService interface {
	...
	CreateNewCasbin(context.Context, _adminModel.CreateCasbin, int) (_adminModel.ResponseCasbin, error)
	...
	DeleteCasbin(context.Context, int) (_roleModel.ResponseCasbin, error)
